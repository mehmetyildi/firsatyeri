...
@section('content')
    <div class="card stick-create-card">
        ...
        <form action="{{route($pageUrl.'.sticks.store',['id'=>$parent->id])}}" method="POST" enctype="multipart/form-data">
            {{csrf_field()}}
                    ...
                    <div class="col col-md-6">
                        ...
                        <div class="row">
                            <div class="form-label-group col-md-6 col-sm-12">
                                ...
                                <input type="number" value="{{ old('before_price')}}" class="form-control" name="before_price"/>
                            </div>
                            <div class="form-label-group col-md-6 col-sm-12">
                                <label for="last_name"  class="control-label">Fırsat Fiyatı</label>
                                <input type="number" value="{{ old('sale_price')}}" class="form-control" name="sale_price"/>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group date date1">
                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input value="{{ old('begin_date')}}" type="text" class="form-control" name="begin_date" autocomplete="off">
                                </div>
                            </div>
                            <hr>
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group date date1">
                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input value="{{ old('end_date')}}" type="text" class="form-control" name="end_date" autocomplete="off">
                                </div>
                            </div>
                        </div>
                    </div>
