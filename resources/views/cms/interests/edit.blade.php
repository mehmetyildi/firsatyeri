			...
			<div class="col-lg-6">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						@include('cms.includes.crop-image-area', ['title' => 'Resmi (200x200)', 'field' => 'image_path', 'ratio' => '1', 'required' => false])
					</div>
				</div>
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						...
						@if($record->image_path)
							<div class="form-group">
								...
								<div class="input-group col-sm-9">
									<img src="{{ url('storage/'.$record->image_path) }}" class="img-responsive" alt="">
								</div>
							</div>
						@else
							Yüklenmiş bir resim yok.
						@endif
