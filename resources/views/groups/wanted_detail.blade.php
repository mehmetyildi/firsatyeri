                        ...
                        <div class="card-body">
                            ...
                            <div class="media-body card mt-3 " id="div-comment-2">
                                <div class="card-header hoverable">
                                    <div class="flex-center">
                                        <a href="{{route('users.detail',['username'=>$wanted->user->username])}}" class="media-object float-left">
                                            <img alt=""
                            ...
                            <div class="col-md-12 answer">
                                <div class="col-md-3 offset-9">
                                    <a href="{{route($pageUrl.'.wanted.sticks.create',['group'=>$group->id, 'wanted'=>$wanted->id])}}"
