...
class BaseController extends Controller
{
    ...
    public function handleImageUpload($record,$urlColumn,$diff,$imageFile,$column,$width,$height){
    ...
    public function handleImageUploadNoResize($record,$urlColumn,$diff,$imageFile,$column){
        ...
        $finalName = $filename.getImageExtension($image->mime());
        $image->save(public_path('storage/'.$finalName));
        $record->$column = $finalName;
    }
    ...
    public function handleGroupImageUpload($record,$urlColumn,$diff,$imageFile,$column){
        ...
        $image->resize($width,$height)->crop(1200, 400, 0, 0)->save(public_path('storage/'.$finalName));
        $record->$column = $finalName;
    }
