...
namespace App\Http\Controllers\Cms\Interests;

use Illuminate\Http\Request;
use App\Http\Controllers\Cms\BaseController;
use App\Models\Interest as PageModel;
use View;
use File;
...
class InterestsController extends BaseController
{
    ...
    public function __construct(PageModel $model)
    {
        ...
        $this->pageUrl = 'interests';
        $this->pageName = 'İlgi Alanları';
        $this->pageItem = 'İlgi Alanı';
        $this->urlColumn = 'name';
        $this->hasUrl = false;
        $this->hasPublish = false;
        $this->model = $model;
        $this->fields = $model::$fields;
        $this->imageFields = $model::$image_fields;
